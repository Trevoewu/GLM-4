...
def main():
    ...
    # Check if CSV files exist in the cmcc-34 directory
    csv_files = ['../data/cmcc-34/train_new.csv', '../data/cmcc-34/dev_new.csv', '../data/cmcc-34/test_new.csv']
    ...
    convert_to_glm4_format('../data/cmcc-34/train_new.csv', 'data/train.jsonl')
    
    print("\nConverting validation set...")
    convert_to_glm4_format('../data/cmcc-34/dev_new.csv', 'data/dev.jsonl')
    
    print("\nConverting test set...")
    convert_to_glm4_format('../data/cmcc-34/test_new.csv', 'data/test.jsonl')
